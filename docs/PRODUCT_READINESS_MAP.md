...
7. The web app has no obvious clipping, overlap, broken scroll, broken focus, or confusing navigation in desktop view.
...
13. Security docs clearly explain what Docker protects, what it does not protect, and what code-run can and cannot attest.
