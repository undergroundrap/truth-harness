...
| `truth_harness_workspace_hard_math_seed_list` | Reopen persisted hard-math seed packets, usually with `preset: "professor-challenge"` and `latest: true`, so agents resume the staged validation queue instead of reseeding duplicate work. |
