...
- `theorem_claim_add/list/show` records claim lineage and review state. A claim ledger record does not prove the claim; it makes dependencies, superseded mistakes, evidence refs, trust labels, and open checks inspectable.
