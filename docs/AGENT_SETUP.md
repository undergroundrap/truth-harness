...
> Use theorem_workspace_init, theorem_source_ingest on docs, theorem_source_cite for "Truth Harness is built for verified math agents", and theorem_ask to check whether "for all integers n, n^2+n+1 is even" is true.
