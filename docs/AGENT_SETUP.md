...
- `truth_harness_research_session_start` and `truth_harness_research_session_checkpoint` write local runbooks; they organize investigations but do not prove any claim by themselves.
