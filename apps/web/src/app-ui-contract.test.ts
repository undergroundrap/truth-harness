...
describe("web UI action contracts", () => {
  ...
  it("shows the browser-safe workspace run-next dry run on the Run tab", async () => {
    ...
    expect(source).toContain("professorChallengeReviewerHandoffHtml(professorChallengeSeed, nextPlan");
    expect(source).toContain("function professorChallengeReviewerHandoffHtml(seed, plan");
    expect(source).toContain("function professorChallengeReviewerHandoffText(seed, plan");
    expect(source).toContain("function professorChallengeArtifactRefs(seed)");
    expect(source).toContain("reviewer handoff packet");
    expect(source).toContain("Everything needed to resume the challenge is local and citable.");
    expect(source).toContain("Truth Harness Professor Challenge Handoff");
    expect(source).toContain("seed-json");
    expect(source).toContain("run-next-json");
    expect(source).toContain("function handleProfessorChallengeAction(action, button)");
    expect(source).toContain("async function copyProfessorChallengeHandoffPacket(button)");
    ...
    expect(source).toContain('data-professor-action="copy-handoff-packet"');
    expect(source).toContain('data-professor-action="copy-seed-command"');
    expect(source).toContain('data-professor-action="copy-next-command"');
    ...
    expect(styles).toContain(".workspace-professor-challenge-handoff");
    expect(styles).toContain(".workspace-professor-challenge-handoff-grid");
    expect(styles).toContain(".workspace-professor-challenge-command-stack");
    expect(styles).toContain(".workspace-professor-challenge-command-card");
