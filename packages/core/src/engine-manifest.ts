  ...
  return [
    {
      ...
      status: "ready",
      role: "arithmetic",
      command: "theorem ask \"compute 3 / 4 + 5 / 8\" --json",
      localOnly: true,
      networkAccess: "none",
    ...
    },
    {
      ...
      status: "ready",
      role: "refutation",
      command: "theorem ask \"for all integers n, n^2+n+1 is even\" --json",
      localOnly: true,
      networkAccess: "none",
    ...
    },
    {
      ...
      status: "ready",
      role: "checker",
      command: "theorem ask \"for all integers n, n^2+n is even\" --json",
      localOnly: true,
      networkAccess: "none",
      strongestTrust: "exact-computed",
      canMintTrust: true,
    ...
    },
    {
      ...
      status: "ready",
      role: "units",
      command: "theorem ask \"dimension check force = mass * acceleration\" --json",
      localOnly: true,
      networkAccess: "none",
    ...
    },
    {
      ...
      status: "ready",
      role: "numeric-bound",
      command: "theorem ask \"bound x^2 + 2*x + 1 for x in [0, 2]\" --json",
      localOnly: true,
      networkAccess: "none",
    ...
    },
    {
      ...
      status: "available",
      role: "cas",
      command: "theorem ask \"symbolic simplify sin(x)^2 + cos(x)^2\" --json",
      executable: "python",
      localOnly: true,
      networkAccess: "none",
      strongestTrust: "exact-computed",
    ...
    },
    {
      ...
      status: "ready",
      role: "retrieval",
      command: "theorem source ingest docs && theorem source search \"verified math agents\"",
      localOnly: true,
      networkAccess: "none",
  ...
  return [
    {
      ...
      command: "theorem claim add ... --evidence receipt:.theorem-workbench/receipts/run.json",
      localOnly: true,
      networkAccess: "none",
      strongestTrust: "none",
      canMintTrust: false,
    ...
    },
    {
      ...
      command: "theorem workspace validate",
      localOnly: true,
      networkAccess: "none",
      strongestTrust: "none",
      canMintTrust: false,
    ...
    },
    {
      ...
      status: "ready",
      role: "privacy-audit",
      command: "theorem model-context prepare ... && theorem disclosure log ...",
      localOnly: true,
      networkAccess: "none",
...
function codeRunSandboxCapability(status: CodeRunSandboxStatus): EngineCapability {
  return {
    ...
    command: "theorem code sandbox-status --json",
    localOnly: true,
...
function proofCapability(probe: ReturnType<typeof getProofBackendStatus>["backends"][number] | undefined): EngineCapability {
  return {
    ...
    status: adapterStatus(probe?.status),
    role: "proof-checker",
    command: "theorem proof check docs/examples/trivial.lean --write",
    executable: probe?.command,
    version: probe?.version,
    localOnly: true,
    networkAccess: "none",
...
function smtCapability(probe: ReturnType<typeof getSmtBackendStatus>["backends"][number] | undefined): EngineCapability {
  return {
    ...
    status: adapterStatus(probe?.status),
    role: "smt-solver",
    command: "theorem smt check docs/examples/constraints.smt2 --write",
    executable: probe?.command,
    version: probe?.version,
    localOnly: true,
    networkAccess: "none",
