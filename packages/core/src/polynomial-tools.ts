...
export function polynomialCapabilities() {
  ...
  return {
    ...
    replay: true,
    lookup: { schema_version: "truth-harness.polynomial-lookup.v1", match_basis: "exact-request-bytes-sha256", max_entries: 256, max_inventory_entries: 8192, pagination: true, requires_replay: true },
